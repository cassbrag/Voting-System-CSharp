...
public partial class AdminVoteDateAdd : System.Web.UI.Page
{
    ...
    {
        Response.Write("<script language='javascript'> alert('A date range has successfully been set!');location.href='AdminVoteDateMenu.aspx'</script>");
    }
}